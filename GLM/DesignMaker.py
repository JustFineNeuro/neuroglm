...
def pac_cont_dsgn_all_complex(Xin,params={'basismain':'cr','nbases':9,'basistypeval':'cr','nbasis':5}):
    '''
    ...
    #Continuous x continuois interaction with wt
    if params['basismain']=='cr':
        ...
        tensor_cont_basis_wt_reldist = patsy.dmatrix("te(bs(x1, degree=3,df=nbases) ,bs(x2,degree=3, df=nbases) ) - 1",
                                          {"x1": Xin['wt'], "x2": Xin['reldist'], "nbases": params['nbases']},
                                          return_type="dataframe")

        tensor_cont_basis_wt_relspeed = patsy.dmatrix("te(bs(x1, degree=3,df=nbases) ,bs(x2,degree=3, df=nbases) ) - 1",
                                                     {"x1": Xin['wt'], "x2": Xin['relspeed'],
                                                      "nbases": params['nbases']},
                                                     return_type="dataframe")
